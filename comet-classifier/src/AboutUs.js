  ...
  return (
    <div className="about-us">
      ...
      <p>Our mission is to provide intuitive and accurate classification tools for astronomical bodies.
        Our dedicated team of astronomers, engineers, and data scientists has worked tirelessly to bring you state-of-the-art technology for comet classification and analysis.
